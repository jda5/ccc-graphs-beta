...
class NavigationPane(BaseNavigationPane):
    ...
    def update_question(self):
        ...
        if screen.question_number == 1 and self.show_info: # If the user has finished question 2 and has not yet seen the info screen
            self.show_info = False  # Prevents Kivy from endlessly looping between screens
            screen.manager.current = 'info_screen'
            return
